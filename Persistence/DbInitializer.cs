...
{
    //We will use this class in the Program.cs file to seed data into the database.
    //This class will be used to seed data into the database when the application starts.
    public static async Task SeedData(AppDbContext context)
    {
        if (context.Activities.Any()) return; // Check if there are any activities already in the database
